...
const Sidebar: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Mail */}
      <Tooltip title="Mail">
        <a href="mailto:priyanirma2000@gmail.com?body=Hi Priyanka," target="_blank" rel="noopener noreferrer" style={{ paddingTop: "1rem" }} >
          <EmailIcon sx={{
            cursor: "pointer", fontSize: 32, color: "white", "&:hover": {
              color: "#61DAFB",
            },
      ...
      <Tooltip title="Download Resume">
        <a href="/Priyanka S Resume25.pdf" download="PriyankaResume.pdf" style={{ paddingTop: "1rem" }}>
          <DownloadIcon sx={{
            cursor: "pointer", fontSize: 32, color: "white", "&:hover": {
              color: "#61DAFB",
            },
